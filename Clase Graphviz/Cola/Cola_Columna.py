...
class Cola_Columna:
    ...
    def Graficar(self, NodoPadre, NoFila, Fila1):
        ...
        if Auxiliar == None:
            #F1C0
            ElTextoGrafica = "F"+str(NoFila)+"C"+str(0)+" [label=\"No hay datos\"];"
            ElTextoGrafica += ""+NodoPadre+" -- "+"F"+str(NoFila)+"C"+str(0)+";"
            return ElTextoGrafica
        else:
            while Auxiliar != None:
                ElTextoGrafica += Auxiliar.Graficar(NodoPadre, NoFila, Fila1)
                Auxiliar = Auxiliar.Siguiente
            return ElTextoGrafica